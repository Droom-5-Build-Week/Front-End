...
import { getExperiancesForUser, getAllMatchsForJS, getAllJobsJP} from '../../Store/Actions/AppActions.js';
...
export default connect(mapStateToProps, { getExperiancesForUser, getAllMatchsForJS, getAllJobsJP})(GeneralJobsList)